...
function loadInfo(){
    ...
    .then((data) => {
        ...
        // console.log(users.name);
                ...
                document.getElementById("exp4").innerHTML=users.experience.location1.description1;
                document.getElementById("exp5").innerHTML=users.experience.location1.description2;
                document.getElementById("exp6").innerHTML=users.experience.location1.description3;
                document.getElementById("exp7").innerHTML=users.experience.location1.details;
